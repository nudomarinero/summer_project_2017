...
Iθ is the flux of the same pixel location as the original image after a 180
degree rotation around a chosen centroid. If `A > 0.2`, the galaxy is classified
as a merger; non-merger otherwise.
