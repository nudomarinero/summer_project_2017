...
with warnings.catch_warnings():
    ...
    for bin_sizes in range(30, 100, 10):
        for n_bins in range(5, 15, 2):
            for thresh_factor in np.linspace(1.75, 3, 3):
                ...
                write_detect_output(detect_output, 'Detections/{}_{}_{}.csv'.format(*parameter.get_params()))
